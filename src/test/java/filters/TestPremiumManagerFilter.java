...
import com.dawidrichert.filters.PremiumManagerFilter;
...
public class TestPremiumManagerFilter extends Mockito {
    ...
    public void get_Should_RedirectToNoAccessPage_When_UserIsNotLogged() throws IOException, ServletException {
        ...
        PremiumManagerFilter filter = new PremiumManagerFilter();
